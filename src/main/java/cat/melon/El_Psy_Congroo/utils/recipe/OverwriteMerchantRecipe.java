 ...
 */
public class OverwriteMerchantRecipe implements OverwriteRecipe {
    ...
    public OverwriteMerchantRecipe(ItemStack result, int maxUses) {
        this(result, 0, maxUses, false);
    }

    public OverwriteMerchantRecipe(ItemStack result, int uses, int maxUses, boolean experienceReward) {
        this.result = result;
        this.uses = uses;
