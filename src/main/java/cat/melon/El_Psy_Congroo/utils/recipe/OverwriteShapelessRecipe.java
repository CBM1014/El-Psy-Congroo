 ...
 */
public class OverwriteShapelessRecipe implements OverwriteRecipe, Keyed {
    ...
    @Deprecated
    public OverwriteShapelessRecipe(ItemStack result) {
     ...
     * @see OverwriteShapelessRecipe#addIngredient(Material)
     * @see OverwriteShapelessRecipe#addIngredient(MaterialData)
     * @see OverwriteShapelessRecipe#addIngredient(Material,int)
     * @see OverwriteShapelessRecipe#addIngredient(int,Material)
     * @see OverwriteShapelessRecipe#addIngredient(int,MaterialData)
     * @see OverwriteShapelessRecipe#addIngredient(int,Material,int)
     */
    public OverwriteShapelessRecipe(NamespacedKey key, ItemStack result) {
        this.key = key;
        this.output = new ItemStack(result);
    }
     ...
     */
    public OverwriteShapelessRecipe addIngredient(MaterialData ingredient) {
     ...
     * @return The changed recipe, so you can chain calls.
     */
    public OverwriteShapelessRecipe addIngredient(Material ingredient) {
     ...
     */
    @Deprecated
    public OverwriteShapelessRecipe addIngredient(Material ingredient, int rawdata) {
     ...
     * @return The changed recipe, so you can chain calls.
     */
    public OverwriteShapelessRecipe addIngredient(int count, MaterialData ingredient) {
     ...
     * @return The changed recipe, so you can chain calls.
     */
    public OverwriteShapelessRecipe addIngredient(int count, Material ingredient) {
     ...
     */
    @Deprecated
    public OverwriteShapelessRecipe addIngredient(int count, Material ingredient, int rawdata) {
    ...
    public OverwriteShapelessRecipe addIngredient(ItemStack ingredient) {
     ...
     */
    public OverwriteShapelessRecipe removeIngredient(RecipeChoice ingredient) {
     ...
     * @return The changed recipe.
     */
    public OverwriteShapelessRecipe removeIngredient(Material ingredient) {
     ...
     * @return The changed recipe.
     */
    public OverwriteShapelessRecipe removeIngredient(MaterialData ingredient) {
     ...
     * @return The changed recipe.
     */
    public OverwriteShapelessRecipe removeIngredient(int count, Material ingredient) {
     ...
     * @return The changed recipe.
     */
    public OverwriteShapelessRecipe removeIngredient(int count, MaterialData ingredient) {
     ...
     */
    @Deprecated
    public OverwriteShapelessRecipe removeIngredient(Material ingredient, int rawdata) {
     ...
     */
    @Deprecated
    public OverwriteShapelessRecipe removeIngredient(int count, Material ingredient, int rawdata) {
