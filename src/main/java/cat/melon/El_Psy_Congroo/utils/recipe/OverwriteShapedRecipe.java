 ...
 */
public class OverwriteShapedRecipe implements OverwriteRecipe, Keyed {
     ...
     * @see OverwriteShapedRecipe#shape(String...)
     * @see OverwriteShapedRecipe#setIngredient(char, Material)
     * @see OverwriteShapedRecipe#setIngredient(char, Material, int)
     * @see OverwriteShapedRecipe#setIngredient(char, MaterialData)
     */
    public OverwriteShapedRecipe(NamespacedKey key, ItemStack result) {
     ...
     */
    public OverwriteShapedRecipe shape(final String... shape) {
     ...
     * @return The changed recipe, so you can chain calls.
     */
    public OverwriteShapedRecipe setIngredient(char key, MaterialData ingredient) {
     ...
     * @return The changed recipe, so you can chain calls.
     */
    public OverwriteShapedRecipe setIngredient(char key, Material ingredient) {
     ...
     */
    @Deprecated
    public OverwriteShapedRecipe setIngredient(char key, Material ingredient, int raw) {
    ...
    public OverwriteShapedRecipe setIngredient(char key, ItemStack ingredient) {
        Validate.isTrue(ingredients.containsKey(key), "Symbol does not appear in the shape:", key);
